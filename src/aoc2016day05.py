...
def main():  # noqa: ANN201, D103
    with Path(r"puzzles/aoc2016day05_data.txt").open(encoding="utf-8") as file:
    ...
    rc.print(f"[cyan](Part One)[/cyan] The password is [green bold]{res_1}[/green bold]")
    rc.print(f"[cyan](Part Two)[/cyan] The password is [green bold]{res_2}[/green bold]")
